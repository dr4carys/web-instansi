...
const readDetailPelaporan = async () => {
  ...
  if (emergency_status == 1 && jenis_krama == 1) {
    link = `https://api.sipandu-beradat.id/pelaporan-darurat-tamu/find/?id_pelaporan_darurat_tamu=${id}`;
  } else if (emergency_status == 0 && jenis_krama == 1) {
    link = `https://api.sipandu-beradat.id/pelaporan-tamu/find/?id_pelaporan_tamu=${id}`;
  } else if (emergency_status == 1 && jenis_krama == 0) {
    link = `https://api.sipandu-beradat.id/pelaporan-darurat/find/?id_pelaporan_darurat=${id}`;
  } else if (emergency_status == 0 && jenis_krama == 0) {
    link = `https://api.sipandu-beradat.id/pelaporan/find/?id_pelaporan=${id}`;
  }
